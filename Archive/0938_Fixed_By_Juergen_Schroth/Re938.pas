...
{$DEFINE ComplexBraces} // define for beta-version of braces //###0.939
...
const
  ...
  ' '#$9#$A#$D#$C; // default for SpaceChars property
	...
	+ 'ABCDEFGHIJKLMNOPQRSTUVWXYZ_'; // default for WordChars property
...
{$ENDIF}
 ...
 TRegExpr = class
   private
    ...
    {$IFDEF ComplexBraces}
    LoopStack : array [0 .. LoopStackMax] of integer; // state before entering loop //###0.939
...
// by recursion.
 var
  ...
  no : integer;
	save : PRegExprChar;
	save_L: PRegExprChar;  //###0.939
  nextch : REChar;
  BracesMin, BracesMax : integer; // we use integer instead of TREBracesArg for better support */+
  {$IFDEF ComplexBraces}
	SavedLoopStack : array [0 .. LoopStackMax] of integer; // :(( very bad for recursion //###0.939
