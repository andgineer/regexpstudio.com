...
$hitmatDir = '/home/anso/public_html/cgi-bin/hitmat';

# URL path to hitmat.cgi
$scriptUrl = 'http://anso.virtualave.net/cgi-bin/hitmat.cgi';

# URL path to hitmat directory
$hitmatUrl = 'http://anso.virtualave.net/cgi-bin/hitmat';

# Go to this URL when exiting manager
$exitUrl = 'http://regexpstudio.com/index.html';

# Log will record hit but exclude domain names matching this tail
$myTail = '.virtualave.net';
