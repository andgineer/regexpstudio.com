...
{
  Простейший тест для библиотеки Delphi Regular Expression
  (www.RegExpStudio.com), совместим с Delphi и FreePascal
  компиляторами.
  Одновременно служит первичным тестом правильности работы
  библиотеки.
  Адаптирован из тестового приложения FreePascal
