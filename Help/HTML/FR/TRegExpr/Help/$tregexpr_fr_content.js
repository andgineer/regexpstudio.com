...
tocTab[ir++] = new Array ("1", "A propos", "about.html", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("2", "Question Légale", "disclaimer.html", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("3", "Installation et liste de fichier", "installation.html", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("4", "Comment ça Fonctionne", "demos.html", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("5", "Syntaxe des Expressions Régulières", "regexp_syntax.html", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("6", "Interface de TRegExpr", "tregexpr_interface.html", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("7", "Projet Demo (TestRExp)", "tregexpr_testrexp.html", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("8", "Exemple: Décorateur HyperLinks", "hyperlinksdecorator.html", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("9", "FAQ", "faq.html", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("10", "Auteur", "author.html", "", "cicon9.gif", "cicon9.gif");
isContent = true,
isIndex = false,
showNumbers = false,
...
function windowErr() {
isDyn = false;
$hmtoc.location.href = "$tregexpr_fr_content.htm";
window.onerror = oldOnError;
}
function reDisplay(currentNumber,tocChange,noLink,e) {
if (isIndex && ($hmtoc.location.href.substring($hmtoc.location.href.lastIndexOf("/")+1,$hmtoc.location.href.length) != "$tregexpr_fr_kwindex.html")) { isIndex=false; isContent=true; }
...
if (isContent && isDyn) {
$hmtoc.document.write("\n\r\n\r<hr><font face=\"Arial,Helvetica\" size=\"1\">© 1999-2004 Andrey V. Sorokin, anso@mail.ru. Version Française par Martin Ledoux, mledoux@citenet.net, martinlmtl@hotmail.com.</font>\n\r</body>\n\r</html>\n\r");
